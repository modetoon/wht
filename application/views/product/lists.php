                                    ...
                                    <?php
                                        foreach($result as $r){
                                            echo '<tr>
                                                ...
                                                <td>'.$r->CommonName.'</td>
                                                <td class="center">
                                                    <a href="'.site_url("product/edit/$r->ProductID").'" class="btn btn-warning btn-xs">Edit</a>&nbsp;
                                                    <a href="'.site_url("product/delete/$r->ProductID").'" class="btn btn-danger btn-xs">Delete</a>
                                                </td>
                                            </tr>';                                       
                                        }
                                    ?>
