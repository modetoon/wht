        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
					<div style="margin:0px auto;padding:20px;text-align:center;"><img src="<?php echo base_url();?>resource/logo.png" width="70"></div>
                    <div class="panel-heading">
                        <h3 class="panel-title">Please Sign In to WHT Admin</h3>
                    </div>
