<?php
	...
	public function get_data_by_date_customer_docno($mode, $startDate, $endDate, $customerId = NULL, $startDocNo = NULL, $endDocNo = NULL) {
	    $selection = array(
		'transaction.TransactionID', 'transaction.DocNo', 'transaction.CustomerID', 'transaction.Remark',
		'transaction.Amount', 'transaction.TaxAmount', 'transaction.NetAmount', 'transaction.TransactionDate',
		'transaction.ExpenseTypeID', 'transaction.Condition', 'transaction.CreatedExcel',
	...
	public function update_created_excel($data, $transactionId) {
	    $this->db->where($this->primary_key, $transactionId)
