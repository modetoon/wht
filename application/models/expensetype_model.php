...
class Expensetype_model extends CI_Model {
    ...
    public function get_menu_parent($parent = 0) {
    ...
    public function get_data_by_wht_type($wht_type) {
        $this->db->where('Wht_Type', $wht_type)
                ->limit(1);
        return $this->db->get($this->table_name)->row();
    }
    ...
    public function get_menu_structure($selected = '') {
    ...
    public function build_menu($category, $parent, $selected = 0) {
        static $i = 1;
        $path = '';
